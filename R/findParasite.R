findParasite <-function(genus, species='', location=''){

possLocs=listLocations()
if(location %in% possLocs == FALSE & location != ''){stop("Please choose a location from the possible locations in the listLocations() function")}
